...
<html>
	...
	<body>
      ...
      <form  action="/HuaWeiS/SpLb" method="post" class="am-avg-sm-2 am-avg-md-4 am-avg-lg-6 am-margin gallery-list">
            ...
            <div class="con" onclick="getFocus(this)">
						商品类名：	<input type="text" name="spname"  placeholder="请输商品类" autocomplete="off" class="layui-input">
						</div>
        
            <div class="gallery-title"><input type="submit" value="添加" /></div>
